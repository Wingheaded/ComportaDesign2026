...
const Exhibitions: React.FC<ExhibitionsProps> = ({ language }) => {
  ...
  return (
    <section id="programme" className="bg-white py-20 md:py-32 scroll-mt-28 relative">
      ...
      {/* Detail Modal */}
      {selectedExhibitor && selectedExhibitor.details && createPortal(
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6">
          {/* Backdrop */}
          <div
            className="absolute inset-0 bg-soft-black/40 backdrop-blur-md animate-backdrop-fade"
            onClick={() => setSelectedExhibitor(null)}
          />

          {/* Modal Content */}
          <div className="relative bg-white w-full max-w-5xl max-h-[90vh] rounded-xl shadow-2xl flex flex-col animate-slide-up-fade overflow-hidden">
